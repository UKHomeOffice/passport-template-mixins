...
module.exports = function (options, deprecated) {
    ...
    var PARTIALS = [
        ...
        'partials/forms/error-group',
        'partials/forms/error-group-end'
    ];
    ...
    return function (req, res, next) {
        ...
        */
        ...
        function errorGroup(key, opts) {
            opts = opts || {};
            var field = getFieldConfig(this.options.fields, key);
            var legend = field.legend;
            var legendClassName = classNames(field, 'legendClassName');
            var legendValue = 'fields.' + key + '.legend';
            if (legend) {
                if (legend.className) {
                    legendClassName = classNameString(field, legend.className);
                }
        ...
        function inputText(key, extension) {
            ...
            return Object.assign(extension, {
                ...
                errorGroup: field.errorGroup || extension.errorGroup,
                groupAttributes: field.groupAttributes,
                groupClassName: field.groupClassName,
        ...
        var mixins = {
            ...
            'error-group': {
                path: 'partials/forms/error-group',
                ...
                handler: function () {
                    ...
                    */
                    return function (key) {
                        ...
                        if (isExact) {
                            dayPart = compiled['partials/forms/input-text-group'].render(inputText.call(this, key + '-day', { pattern: '[0-9]*', min: 1, max: 31, maxlength: 2, hintId: key + '-hint', errorGroup: key, autocomplete: autocomplete.day }));
                            parts.push(dayPart);
                        }

                        monthPart = compiled['partials/forms/input-text-group'].render(inputText.call(this, key + '-month', { pattern: '[0-9]*', min: 1, max: 12, maxlength: 2, hintId: key + '-hint', errorGroup: key, autocomplete: autocomplete.month }));
                        yearPart = compiled['partials/forms/input-text-group'].render(inputText.call(this, key + '-year', { pattern: '[0-9]*', maxlength: 4, hintId: key + '-hint', errorGroup: key, autocomplete: autocomplete.year }));
                ...
                handler: function () {
                    return function (key) {
                        var parts = [
                            ...
                            res.locals['error-group-end']().call(this, key)
                        ];
                        return parts.join('\n');
                    };
                }
