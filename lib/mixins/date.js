...
module.exports = Controller => class extends Controller {
    configure(req, res, next) {
        ...
        req.form.options.dateFields.forEach(fieldName => this.configureDateField(req, fieldName));
    ...
    process(req, res, next) {
        req.form.options.dateFields.forEach(fieldName => this.processDateField(req, fieldName));
    ...
    validateFields(req, res, callback) {
        super.validateFields(req, res, errors => {
            req.form.options.dateFields.forEach(fieldName => this.validateDateField(req, fieldName, errors));
            callback(errors);
        });
    }
    ...
    validateDateField(req, fieldName, errors) {
        ...
        if (numericErrors) {
            ...
            errors[fieldName] = new this.Error(fieldName, { type: errorType }, req);
            return;
        }
        ...
        if (invalidElement) {
            errors[fieldName] = new this.Error(fieldName, { type: 'date-invalid-' + invalidElement }, req);
